---
title: Lync Server 2013 中的架構屬性 (按類別)
TOCTitle: Lync Server 2013 中的架構屬性 (按類別)
ms:assetid: 72726b43-f1ea-458c-9304-a26e8a12128c
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Gg398544(v=OCS.15)
ms:contentKeyID: 49291295
ms.date: 08/10/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013 中的架構屬性 (按類別)

 

_**上次修改主題的時間：** 2015-03-09_

本節列出可包含在每個 Lync Server 2013 類別中的架構屬性，以及可包含在其他類別中的類別。如需所有類別及其描述的清單，請參閱＜[Lync Server 2013 中的架構類別和描述](lync-server-2013-schema-classes-and-descriptions.md)＞。如需所有屬性及其描述的清單，請參閱＜[Lync Server 2013 中的架構屬性和描述](lync-server-2013-schema-attributes-and-descriptions.md)＞。
