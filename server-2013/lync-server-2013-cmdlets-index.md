...
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Gg398867(v=OCS.15)
ms:contentKeyID: 49292341
ms.date: 08/10/2015
...
Microsoft Lync Server 2013 隨附超過 700 個 Cmdlet，可讓系統管理員從命令列管理 Lync Server 2013。Lync Server Cmdlet 通常搭配 Lync Server 管理命令介面使用。使用 Lync Server 管理命令介面的其中一個方式，就是登入執行 Lync Server 服務或伺服器角色的電腦，然後依序按一下 \[開始\]、\[所有程式\]、\[Microsoft Lync Server 2013\] 和 \[Lync Server 管理命令介面\]。管理命令介面開啟之後，您就可以輸入類似下方的命令，直接從命令列擷取 Cmdlet 的說明：

    Get-Help New-CsVoicePolicy -Full

上述命令會擷取適用 **New-CsVoicePolicy** Cmdlet 的完整說明。若要檢視不同 Cmdlet 的說明，可將 **New-CsVoicePolicy** 替換為要擷取其說明的 Cmdlet 名稱。

若要擷取用來管理 Lync Server 的 Cmdlet 的完整清單，請在 Lync Server 管理命令介面命令提示字元中輸入：

    Get-Command * -Module Lync -CommandType cmdlet

如需關於使用 Lync Server 管理命令介面的詳細資訊，請參閱 Lync Server Windows PowerShell 部落格，網址為 [http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x404](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x404)。

## Lync Server 2013 Cmdlet

以下列出 Lync Server 2013 隨附的 Cmdlet：
