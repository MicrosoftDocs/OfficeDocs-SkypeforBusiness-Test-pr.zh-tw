---
title: UserAgentDef 資料表 (QoE)
TOCTitle: UserAgentDef 資料表 (QoE)
ms:assetid: cfd8e3e0-4076-4162-9381-5276da8316d9
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ205259(v=OCS.15)
ms:contentKeyID: 49292376
ms.date: 08/24/2015
mtps_version: v=OCS.15
ms.translationtype: HT
---

# UserAgentDef 資料表 (QoE)

 

_**上次修改主題的時間：** 2015-03-09_

UserAgentDef 表格可將使用者代理程式識別碼對應到代理程式的描述性名稱。使用者代理程式是可用以連線到 Microsoft Lync Server 2013 的軟體用戶端。
