...
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dn767945(v=OCS.15)
ms:contentKeyID: 62486249
ms.date: 08/10/2015
...
For more information on OU permissions, see the article [Lync Server 2013 中的 Computers、Users 或 InetOrgPerson 容器已停用權限繼承](lync-server-2013-permissions-inheritance-is-disabled-on-computers-users-or-inetorgperson-containers.md).
