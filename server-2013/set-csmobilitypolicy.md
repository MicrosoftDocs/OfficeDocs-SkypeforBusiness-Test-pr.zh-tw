...
<td><p>讓系統管理員提供隨附於行動原則的其他文字。例如，Description 可包含被指派原則的使用者相關資訊。</p></td>
</tr>
<tr class="even">
...
<td><p>建立原則時指派給原則的唯一識別碼。行動原則可以在全域、網站或個別使用者範圍指派。若要參考全域執行個體，請使用下列語法：</p>
<p>-Identity global</p>
<p>若要在網站範圍內參照原則，請使用類似下列的語法：</p>
<p>-Identity site:Redmond</p>
<p>若要參考個別使用者原則，請使用類似下列的語法：</p>
<p>-Identity RedmondMobilityPolicy</p>
<p>若未指定 Identity，則 Set-CsMobilityPolicy Cmdlet 將會修改全域原則。</p></td>
</tr>
<tr class="odd">
