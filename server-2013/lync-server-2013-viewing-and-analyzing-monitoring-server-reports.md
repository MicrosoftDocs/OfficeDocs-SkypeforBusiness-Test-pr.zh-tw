...
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dn720332(v=OCS.15)
ms:contentKeyID: 62221761
ms.date: 08/10/2015
...
2.  Open a browser window, and then enter the Admin URL to open the Lync Server 控制台.
...
[Lync Server 2013 中的媒體品質比較報表](lync-server-2013-media-quality-comparison-report.md)
