...
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ205100(v=OCS.15)
ms:contentKeyID: 49291724
ms.date: 08/10/2015
...
UserAgentDef 表格會將使用者代理程式識別碼對應至代理程式的描述性名稱。使用者代理程式為用來連線至 Microsoft Lync Server 2013 的軟體用戶端。本表已從 Microsoft Lync Server 2013 引進使用。
